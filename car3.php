...
<head>
    ...
    <title>Nissan Skylinne GTR R34</title>
...
<body>
    ...
    <main>
        <h1>Nissan Skylinne GTR R34</h1>
        <h2>Ano:1995</h2>
        <img src="imagens/car3.jpg" alt="">
        <ul>
            <li>Tipo:Cupê</li>
            <li>Portas:Duas</li>
            <li>Potencia Máxima: 320cv</li>
            <li>Torque: 39,97Kgfm</li>
            <li>Câmbio: Manual de 6 Marchas</li>
            <li>Tração:Integral</li>
            <li>Velocidade Máxima: 265KM/H</li>
            <li>0 á 100: 5,3s</li>
            <li>Consumo: Cidade<i class='bx bx-right-arrow-alt'></i>16KM/L Rodovia<i
                    class='bx bx-right-arrow-alt'></i>7KM/L</li>
        </ul>
    </main>
