...
<body>
    ...
    <main>
        ...
        <ul>
            <li>Tipo:Cupê</li>
            <li>Portas:Duas</li>
            <li>Potencia Máxima: 255cv</li>
            <li>Torque: 30Kgfm</li>
            <li>Câmbio: Manual de 5 Marchas</li>
            <li>Tração:Traseira</li>
            <li>Velocidade Máxima: 250KM/L</li>
            <li>0 á 100: 5,3s</li>
            <li>Consumo: Cidade<i class='bx bx-right-arrow-alt'></i>4KM/L Rodovia<i
